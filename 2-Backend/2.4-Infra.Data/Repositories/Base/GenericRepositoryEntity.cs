...
{
    public class GenericRepositoryEntity<TEntity> : IGenericRepositoryEntity<TEntity> where TEntity : Entity
    {
        private readonly DbContextGeneric _context;
        protected readonly DbSet<TEntity> _dbSet;

        public GenericRepositoryEntity(DbContextGeneric context)
        {
            _context = context;
